...
@section('content')
    ...
    <div class="max-w-2xl mb-12 text-left">
        <nav class="mb-6">
            <a href="{{ route('programmer.dashboard') }}" class="group inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-widest text-slate-400 transition-colors hover:text-[#8a0b4e]">
        ...
        <p class="mt-2 text-sm text-slate-500">Kelola identitas dan keamanan personal Anda sebagai Programmer.</p>
    </div>
